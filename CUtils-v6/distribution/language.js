...
/*! Version: CumulusUtils 3.5.7 - Updated: 16 may 2020 Norwegian by Steiner Utne (minor corrections) */
...
LANG.EN = {
    ...
    apptemp_info      : 'Apparent Temperature',
...
LANG.FR = {
    canvasnosupport: 'Votre navigateur ne supporte pas la fonction Canvas de HTML5 ...Désolé...<br>' +
                     'Une mise à jour de votre navigateur à une version plus récente est requise - presque tous les ' +
                     'navigateurs supportent HTML5 maintenant, incluant IE9!<br><br>' +
    ...
    uv_details: ['Il fait encore nuit ou c\'est une journée très nuageuse.',
                  ...
                  'Portez des lunettes de soleil lors de journées ensoleillées. Si vous restez à l’extérieur pendant ' +
                  'plus d’une heure, couvrez-vous et utilisez un écran solaire.<br>' +
                  'La réflexion par la neige peut presque doubler l’intensité des rayons UV. Portez des lunettes de soleil ' +
                  'et appliquez un écran solaire sur votre visage.',

                  'Prenez des précautions : couvrez-vous, portez un chapeau et des lunettes de soleil, et appliquez ' +
                  'un écran solaire, surtout si vous êtes à l’extérieur pendant 30 minutes ou plus.<br>' +
                  ...
                  'Évitez le soleil entre 11 h et 16 h, prenez toutes les précautions : cherchez l’ombre, couvrez-vous, ' +
                  'portez un chapeau, des lunettes de soleil et appliquez un écran solaire.',

                  'Précautions supplémentaires nécessaires : la peau non protégée sera endommagée et peut brûler rapidement.<br>' +
                  'Évitez le soleil entre 11 h et 16 h. Cherchez l’ombre, couvrez-vous, portez un chapeau ' +
                  'et des lunettes de soleil et appliquez un écran solaire.',

                  'Les valeurs de 11 ou plus sont très rares. Cependant, l’indice UV peut atteindre 14 ou ' +
                  'plus dans les tropiques ou le sud des États-Unis.<br>' +
                  'Prenez toutes les précautions. La peau non protégée sera endommagée et peut brûler en quelques minutes. ' +
                  'Évitez le soleil entre 11 h et 16 h, couvrez-vous, portez un chapeau et des lunettes de soleil et appliquez un écran solaire.<br>' +
...
//======================================================================================================================
// Deutsch by RASter & wurzelmac (last workover: 2015 03 08)
//======================================================================================================================
LANG.DE = {
    canvasnosupport: 'Ihr Browser hat keine HTML5 Canvas Unterstützung.<br>' +
                      'Aktualisieren Sie Ihren Browser auf eine neuere Version, fast alle Browser unterstützen Canvas heutzutage, sogar der IE9!<br><br>' +
    ...
    uv_details: ['Es ist entweder Nacht oder ein sehr bewölkter Tag.',
                  ...
                  'wenn Sie besonders helle Haut haben oder wenn Schnee liegt welcher UV-Strahlung<br>' +
                  'reflektiert.',

                  'Tragen Sie eine Sonnenbrille und verwenden Sie Sonnencreme mit Lichtschutzfaktor<br>' +
                  '30 oder höher. Bedecken Sie den Körper mit Kleidung und tragen Sie einen Hut.<br>' +
                  'Suchen Sie um die Mittagszeit, wenn die Sonne am stärksten ist, Schatten auf.',

                  'Tragen Sie eine Sonnenbrille und verwenden Sie Sonnencreme mit Lichtschutzfaktor<br>' +
                  '30 oder höher. Schützen Sie den Körper durch entsprechende Kleidung und einen<br>' +
                  'breitkrempigen Hut. Begrenzen Sie den Aufenthalt in der Sonne zwei Stunden vor bis<br>' +
                  'drei Stunden nach dem solaren Mittag (ca. 11:00 - 16:00 Uhr in Ländern mit<br>' +
                  'Sommerzeit) auf ein Minimum.',

                  'Benutzen Sie Sonnencreme, Lichtschutzfaktor 30 oder höher. Tragen Sie eine<br>' +
                  'Sonnenbrille, T-Shirt und einen Hut. Bleiben Sie nicht zu lange in der Sonne.',

                  'Treffen Sie alle Vorsichtsmaßnahmen: tragen Sie eine Sonnenbrille und benutzen Sie<br>' +
                  'Sonnencreme, Lichtschutzfaktor 30 oder höher, bedecken Sie den Körper mit einem<br>' +
                  'langärmeligen T-Shirt, tragen Sie lange Hosen und einen breiten Hut, meiden Sie die<br>' +
                  'Sonne zwei Stunden vor bis drei Stunden nach dem solaren Mittag (ca. 11:00 - 16:00<br>' +
                  'Uhr in Ländern mit Sommerzeit).'],
    //
    ...
    cloudbase_popup_text : 'Die Berechnung ist einfach: 122 Meter für je 1,0 Grad Celsius Differenz zwischen<br>' +
                           'Temperatur und Taupunkt. Beachte, dass dies nur die theoretische Höhe angibt,<br>' +
...
LANG.NL = {
    ...
    dew_info          : 'Dauwpunt',
    dew_web           : 'Dauwpunt',
    apptemp_title     : 'Schijnbaar',
    apptemp_info      : 'Schijnbaartemperatuur',
    apptemp_web       : 'Schijnbaar',
    feel_title        : 'Voelt Als',
    feel_info         : 'Voelt Als Temperature',
    feel_web          : 'Voelt Als',
...
//======================================================================================================================
// Swedish (no longer SE but SV (from sv-SE code)
//======================================================================================================================
LANG.SV = {
...
LANG.NB = {
    ...
    StatusPageLimit   : 'Automatisk oppdatering er tidsbegrenset, du må oppdatere (F5) siden for å fortsette',
    //
    ...
    dew_info          : 'Doggpunkt',
    dew_web           : 'Doggpunkt',
    apptemp_title     : 'Opplevd',
    apptemp_info      : 'Opplevd temperatur',
    apptemp_web       : 'Opplevd',
    feel_title        : 'Feels Like',
    feel_info         : 'Feels Like Temperature',
    feel_web          : 'Feels Like',
    ...
    //
    wind_title        : 'Vindstyrke',
    tenminavg_title   : 'Snitt vindstyrke',
    tenminavgwind_info: 'Snitt vindstyrke (10 min)',
    maxavgwind_info   : 'Maks. snitt vindstyrke',
    tenmingust_info   : 'Vindkast (10 min)',
    maxgust_info      : 'Kraftigste vindkast',
    latest_title      : 'Siste vind',
    latestwind_info   : 'Siste vind',
    bearing_info      : 'Retning',
    latest_web        : 'Siste',
    tenminavg_web     : 'Snitt',
    ...
    //
    cloudbase_title      : 'Skyhøyde',
    cloudbase_popup_title: 'Teoretisk skyhøyde',
    cloudbase_popup_text : 'Beregningen er en enkel en: 300 meter for hver 2,5 grader Celsius<br>' +
                           'forskjell mellom temperaturen og duggpunktet. Legg merke til at dette<br>' +
                           'gir bare den teoretiske høyden hvor cumulusskyer ville begynne å dannes, <br>' +
                           'når luften er mettet.',
    feet              : 'fot',
    metres            : 'meter',
    miles             : 'mil',
    n_miles           : 'n.mil',
...
//
LANG.NN = {
    canvasnosupport: 'Nettlesar stør ikkje HTML5 Canvas-støtte ... Orsak ...<br>' +
                     'Oppgrader nettlesaren til ein nyare versjon - nesten alle nettlsarar støtter Canvas nå, sjølv IE9!<br><br>' +
                     'Omdirigerer deg til den \'gamle\' sida for Instrument ...',
    //
    led_title         : 'Fjernsensor: Status ukjend',
    led_title_ok      : 'Fjernsensor: OK',
    led_title_lost    : 'Fjernsensor: Mista kontakt!',
    led_title_unknown : 'Fjernsensor: Status ukjend!',
    led_title_offline : 'Vêrstasjonen er ikkje aktiv.',
    //
    weather           : 'vêr',
    latitude          : 'Breidegrad',
    longitude         : 'Lengdegrad',
    ...
    //
    statusStr         : 'Lastar...',
    StatusMsg         : 'Lastar ned...',
    StatusHttp        : 'HTTP forespurnad mislykkast',
    StatusRetry       : 'Prøver igjen...',
    StatusRetryIn     : 'Prøver igjen om...',
    StatusTimeout     : 'Tidsavbrot',
    StatusPageLimit   : 'Automatisk oppdatering er tidsbegrensa, du må oppdatere (F5) sida for å fortsette',
    //
    StatusLastUpdate  : 'Siste oppdatering',
    StatusMinsAgo     : 'minutter sidan',
    StatusHoursAgo    : 'timar sidan',
    StatusDaysAgo     : 'dagar sidan',
    //
    realtimeCorrupt   : 'Tekstfilnedlasting avbrote! Prøver på nytt ...',
    //
    timer             : 'sekundar',
    at                : 'klokka',
    //
    ...
    rrate_title       : 'Nedbør',
    rrate_info        : 'Nedbørsrate',
    LastRain_info     : 'Siste nedbør',
    LastRainedT_info  : 'I dag klokka',
    LastRainedY_info  : 'I går klokka',
    //
    hum_title_out     : 'Luftfukt',
    hum_title_in      : 'Luftfukt inne',
    hum_out_info      : 'Luftfukt ute',
    hum_in_info       : 'Luftfukt inne',
    hum_out_web       : 'Ute',
    hum_in_web        : 'Inne',
    //
    baro_title        : 'Trykk',
    ...
    maxavgwind_info   : 'Maks. snitt vindstyrke',
    tenmingust_info   : 'Vindkast (10 min)',
    maxgust_info      : 'Kraftigaste vindkast',
    latest_title      : 'Siste vind',
    latestwind_info   : 'Siste vindstyrke',
    bearing_info      : 'Retning',
    latest_web        : 'Siste',
    tenminavg_web     : 'Snitt',
    dominant_bearing  : 'Dominerande vind i dag',
    calm              : 'stille',
    windrose          : 'Vindrose',
    windruntoday      : 'Vindstrekning i dag',
    //
    ...
    uv_levels         : ['Inga',
                         ...
                         'Ekstrem risiko'],
    uv_headlines: ['Ingen målbar UV Indeks',
                   'Inga fare for ein \'gjennomsnittleg\' person',
                   'Liten risiko for skade frå ubeskytta soling',
                   'Høg risiko for skade frå ubeskyttet soling',
                   'Mykje høg risiko for skade frå ubeskytta soling',
                   'Ekstrem risiko for skade frå ubeskytta soling'],
    uv_details: ['Det er fortsatt natt - eller det er ein mykje  overskya dag.',

                 'Bruk solbriller på lyse dagar, bruk solkrem dersom det er snø på bakken,<br>' +
                 'som reflekterer UV-stråling - om du ikkje har spesiell god hud.',

                 'Bruk solbriller og SPF30 + solkrem, dekk kroppen med klær og<br>' +
                 'ein lue, søk skygge midt på dagen når solen er mest intens.',

                 'Bruk solbriller og SPF30 + solkrem, dekk kroppen med solbeskyttende<br>' +
                 'klær og ein skyggelue, reduser tid i sola frå to timer før<br>' +
                 'til tre timar etter at sola er på det høgaste (ca 11:00 til 16:00 om sommeren i<br>' +
                 '(soner som bruker sommertid).',
                 ...
                 'Ta alle forholdsregler, inkludert: bruk av solbriller samt bruk SPF30 + solkrem,<br>' +
                 'dekk kroppen med ein langermet skjorte og bukse, bruk skyggelue og<br>' +
                 'unngå sola frå to timer før til tre timer etter at sola er på det høyeste (ca 11:00<br>' +
                 'til 16:00 om sommaren i soner som bruker sommartid).'],
    //
    solar_title          : 'Solstråling',
    solar_currentMax     : 'Noverande teoretiske maksimale måling',
    solar_ofMax          : 'av maksimalt',
    solar_maxToday       : 'Dagens maksimale måling',
    //
    cloudbase_title      : 'Skyhøgda',
    cloudbase_popup_title: 'Teoretisk skyhøgd',
    cloudbase_popup_text : 'Berekninga er enkel: 300 meter for kvar 2,5 gradar Celsius<br>' +
                           'skilnad mellom temperaturen og doggpunktet. Ver merksam at dette<br>' +
                           'berre gjev den teoretiske høgda der cumulusskyar vert danna <br>' +
                           'når lufta er metta.',
    feet              : 'fot',
    metres            : 'meter',
    miles             : 'mil',
    ...
    lowest_info       : 'Lågast',
    highest_info      : 'Høgast',
    lowestF_info      : 'Lågast',     // for proper translation of feminine words
    highestF_info     : 'Høgast',    // for proper translation of feminine words
    //
    RisingVeryRapidly : 'Aukar veldig raskt',
    RisingQuickly     : 'Aukar raskt',
    Rising            : 'Aukar',
    RisingSlowly      : 'Aukar sakte',
    Steady            : 'Jamn',
    FallingSlowly     : 'Fell sakte',
    Falling           : 'Fell',
    FallingQuickly    : 'Fell raskt',
    FallingVeryRapidly: 'Fell veldig raskt',
    //
    maximum_info      : 'Maks.',
    max_hour_info     : 'Maks. pr. time',
    minimum_info      : 'Min.',
    //
    coords            : ['N', 'NNA', 'NA', 'ANA', 'A', 'ASA', 'SA', 'SSA', 'S', 'SSV', 'SV', 'VSV', 'V', 'VNV', 'NV', 'NNV'],
...
LANG.IT = {
    canvasnosupport: 'HTML5 Canvas non supportato dal tuo browser... Spiacente...<br>' +
                     'Prova ad aggiornare il tuo browser ad una versione pi&egrave; recente - quasi tutti i ' +
                     'browser supportano Canvas adesso, eccetto IE9!<br><br>' +
...
LANG.ES = {
    canvasnosupport: 'No hay soporte para HTML5 en su navegador ... Lo siento ...<br>' +
                     'Trate de actualizar su navegador a una versión más reciente - casi todos los navegadores ' +
                     'son compatibles con él ahora, incluso IE9!<br><br>' +
...
LANG.CT = {
    canvasnosupport: 'No hi ha suport per HTML5 en el seu navegador ... Ho sento ...<br>' +
                     'Intenta actualitzar el vostre navegador a una versió més recent - gairebé tots els navegadors ' +
                     'són compatibles amb HTML5 ara, fins i tot IE9!<br><br>' +
...
function changeLang(newLang, updateGauges) {
    updateGauges = typeof updateGauges === 'undefined' ? true : updateGauges;
