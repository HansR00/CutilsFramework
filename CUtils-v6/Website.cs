            ...
            using ( StreamWriter of = new StreamWriter( $"{Sup.PathUtils}index.html", false, Encoding.UTF8 ) )
            {
                ...
                indexFile.Append(
                   ...
                   $"  <td style='width:20%;text-align:right'>{Sup.GetUtilsIniValue( "Website", "HeaderRightText", "" )}</td>" +
                    ...
                    //"    <ul id='CurrentpwsFWI' class='navbar-nav' >" +
                    //"      <li class='nav-item'>" +
...
<li><a href='https://github.com/mcrossley/SteelSeries-Weather-Gauges'>Steelseries by Gerrit Grunwald</a> - License: GNU GPL V 2.0;<br/>
...
If I forgot anybody or anything or made the wrong interpretation or reference, please let me know and I will correct. You can contact me at the <a href='https://cumulus.hosiene.co.uk/viewtopic.php?f=14&t=17573'>Cumulus Support Forum</a>, user: HansR" +
        ...
        private void GenerateCumulusChartsTxt()
        {
            ...
            else // Default charts
            {
                ...
                //
                bool ShowInsideMeasurements = Sup.GetUtilsIniValue( "Website", "ShowInsideMeasurements", "true" ).Equals( "true" );
        ...
        public bool CheckPackageAndCopy()
        {
            ...
            foreach ( string file in Package )
            {
                ...
                if ( File.Exists( filename ) )
                {
                    ...
                    {
                        if ( !CMXutils.Thrifty || ( CMXutils.Thrifty && MustUpload ) )
                        {
        ...
        string GeneratePanelCode( string thisPanel )
        {
